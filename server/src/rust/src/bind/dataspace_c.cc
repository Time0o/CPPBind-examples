...
#include "/home/timo/github/projects/l4re/l4/pkg/cppbind-examples/server/src/rust/src/bind/dataspace_c.h"
...
void l4_re_dataspace_delete(const struct l4_re_dataspace * __self)
{
  using namespace L4Re;
...
long l4_re_dataspace_copy_in(const struct l4_re_dataspace * __self, unsigned long long a_1, const struct l4_ipc_cap_dataspace * a_2, unsigned long long a_3, unsigned long long a_4)
{
  using namespace L4;
  using namespace Ipc;
  using namespace Msg;
  ...
  _a_2 = cppbind::c::struct_cast<const L4::Ipc::Cap<L4Re::Dataspace>>(a_2);
...
void l4_re_dataspace_f_delete(const struct l4_re_dataspace_f * __self)
{
  using namespace L4Re;

  const L4Re::Dataspace::F * ___self;

  ___self = cppbind::c::struct_cast<const L4Re::Dataspace::F>(__self);
...
void l4_re_dataspace_flags_delete(const struct l4_re_dataspace_flags * __self)
{
  using namespace L4Re;
