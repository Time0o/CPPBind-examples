...
#include "/home/timo/github/projects/l4re/l4/pkg/cppbind-examples/server/src/rust/src/bind/rm_c.h"
...
long l4_re_rm_attach(const struct l4_re_rm * __self, l4_addr_t * start, unsigned long size, l4_uint_32_t flags, const struct l4_ipc_cap_dataspace * mem, l4_re_rm_offset_t offs, unsigned char align)
{
  using namespace L4Re;
  ...
  _mem = cppbind::c::struct_cast<const L4::Ipc::Cap<L4Re::Dataspace>>(mem);
...
int l4_re_rm_detach_1(const struct l4_re_rm * __self, l4_addr_t addr, struct l4_cap_dataspace * mem, const struct l4_cap_task * task)
{
  using namespace L4Re;
  ...
  _mem = cppbind::c::struct_cast<L4::Cap<L4Re::Dataspace>>(mem);

  _task = cppbind::c::struct_cast<const L4::Cap<L4::Task>>(task);
...
int l4_re_rm_detach_2(const struct l4_re_rm * __self, void * addr, struct l4_cap_dataspace * mem, const struct l4_cap_task * task)
{
  using namespace L4Re;
...
int l4_re_rm_detach_3(const struct l4_re_rm * __self, l4_addr_t start, unsigned long size, struct l4_cap_dataspace * mem, const struct l4_cap_task * task)
{
  using namespace L4Re;
...
int l4_re_rm_find(struct l4_re_rm * __self, l4_addr_t * addr, unsigned long * size, l4_re_rm_offset_t * offset, l4_re_rm_flags_t * flags, struct l4_cap_dataspace * m)
{
  using namespace L4Re;
  ...
  _m = cppbind::c::struct_cast<L4::Cap<L4Re::Dataspace>>(m);
...
int l4_re_rm_detach_4(const struct l4_re_rm * __self, l4_addr_t start, unsigned long size, struct l4_cap_dataspace * mem, const struct l4_cap_task * task, unsigned int flags)
{
  using namespace L4Re;
...
void l4_re_rm_delete(const struct l4_re_rm * __self)
{
  using namespace L4Re;
...
long l4_re_rm_attach_void(const struct l4_re_rm * __self, void ** start, unsigned long size, l4_uint_32_t flags, const struct l4_ipc_cap_dataspace * mem, l4_re_rm_offset_t offs, unsigned char align)
{
  using namespace L4Re;
...
void l4_re_rm_f_delete(const struct l4_re_rm_f * __self)
{
  using namespace L4Re;

  const L4Re::Rm::F * ___self;

  ___self = cppbind::c::struct_cast<const L4Re::Rm::F>(__self);
...
void l4_re_rm_f_flags_delete(const struct l4_re_rm_f_flags * __self)
{
  using namespace L4Re;
